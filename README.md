...
[![Go Report Card](https://goreportcard.com/badge/github.com/Terisback/bot)](https://goreportcard.com/report/github.com/Terisback/bot) [![codecov](https://codecov.io/gh/go-telegram/bot/branch/main/graph/badge.svg?token=57B1OR6PCK)](https://codecov.io/gh/go-telegram/bot)
...
```bash
go get -u github.com/Terisback/bot
```
