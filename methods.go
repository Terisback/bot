...
import (
	...
	"github.com/Terisback/bot/models"
)
...
// SetWebhook https://core.telegram.org/bots/api#setwebhook
func SetWebhook(ctx context.Context, token string, params *SetWebhookParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setWebhook", params, &result)
	return result, err
}

// DeleteWebhook https://core.telegram.org/bots/api#deletewebhook
func DeleteWebhook(ctx context.Context, token string, params *DeleteWebhookParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteWebhook", params, &result)
	return result, err
}

// GetMe https://core.telegram.org/bots/api#getme
func GetMe(ctx context.Context, token string) (*models.User, error) {
	result := &models.User{}
	err := rawRequest(ctx, token, "getMe", nil, result)
	return result, err
}

// Logout https://core.telegram.org/bots/api#logout
func Logout(ctx context.Context, token string) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "logout", nil, &result)
	return result, err
}

// Close https://core.telegram.org/bots/api#close
func Close(ctx context.Context, token string) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "close", nil, &result)
	return result, err
}

// SendMessage https://core.telegram.org/bots/api#sendmessage
func SendMessage(ctx context.Context, token string, params *SendMessageParams) (*models.Message, error) {
	mes := &models.Message{}
	err := rawRequest(ctx, token, "sendMessage", params, mes)
	return mes, err
}

// ForwardMessage https://core.telegram.org/bots/api#forwardmessage
func ForwardMessage(ctx context.Context, token string, params *ForwardMessageParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "forwardMessage", params, result)
	return result, err
}

// ForwardMessages https://core.telegram.org/bots/api#forwardmessages
func ForwardMessages(ctx context.Context, token string, params *ForwardMessagesParams) ([]models.MessageID, error) {
	var result []models.MessageID
	err := rawRequest(ctx, token, "forwardMessages", params, &result)
	return result, err
}

// CopyMessage https://core.telegram.org/bots/api#copymessage
func CopyMessage(ctx context.Context, token string, params *CopyMessageParams) (*models.MessageID, error) {
	result := &models.MessageID{}
	err := rawRequest(ctx, token, "copyMessage", params, result)
	return result, err
}

// CopyMessages https://core.telegram.org/bots/api#copymessages
func CopyMessages(ctx context.Context, token string, params *CopyMessagesParams) ([]models.MessageID, error) {
	var result []models.MessageID
	err := rawRequest(ctx, token, "copyMessages", params, &result)
	return result, err
}

// SendPhoto https://core.telegram.org/bots/api#sendphoto
func SendPhoto(ctx context.Context, token string, params *SendPhotoParams) (*models.Message, error) {
	mes := &models.Message{}
	err := rawRequest(ctx, token, "sendPhoto", params, mes)
	return mes, err
}

// SendAudio https://core.telegram.org/bots/api#sendaudio
func SendAudio(ctx context.Context, token string, params *SendAudioParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendAudio", params, result)
	return result, err
}

// SendDocument https://core.telegram.org/bots/api#senddocument
func SendDocument(ctx context.Context, token string, params *SendDocumentParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendDocument", params, result)
	return result, err
}

// SendVideo https://core.telegram.org/bots/api#sendvideo
func SendVideo(ctx context.Context, token string, params *SendVideoParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendVideo", params, result)
	return result, err
}

// SendAnimation https://core.telegram.org/bots/api#sendanimation
func SendAnimation(ctx context.Context, token string, params *SendAnimationParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendAnimation", params, result)
	return result, err
}

// SendVoice https://core.telegram.org/bots/api#sendvoice
func SendVoice(ctx context.Context, token string, params *SendVoiceParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendVoice", params, result)
	return result, err
}

// SendVideoNote https://core.telegram.org/bots/api#sendvideonote
func SendVideoNote(ctx context.Context, token string, params *SendVideoNoteParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendVideoNote", params, result)
	return result, err
}

// SendPaidMedia https://core.telegram.org/bots/api#sendpaidmedia
func SendPaidMedia(ctx context.Context, token string, params *SendPaidMediaParams) (*models.Message, error) {
	var result models.Message
	err := rawRequest(ctx, token, "sendPaidMedia", params, &result)
	return &result, err
}

// SendMediaGroup https://core.telegram.org/bots/api#sendmediagroup
func SendMediaGroup(ctx context.Context, token string, params *SendMediaGroupParams) ([]*models.Message, error) {
	var result []*models.Message
	err := rawRequest(ctx, token, "sendMediaGroup", params, &result)
	return result, err
}

// SendLocation https://core.telegram.org/bots/api#sendlocation
func SendLocation(ctx context.Context, token string, params *SendLocationParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendLocation", params, result)
	return result, err
}

// EditMessageLiveLocation https://core.telegram.org/bots/api#editmessagelivelocation
func EditMessageLiveLocation(ctx context.Context, token string, params *EditMessageLiveLocationParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "editMessageLiveLocation", params, result)
	return result, err
}

// StopMessageLiveLocation https://core.telegram.org/bots/api#stopmessagelivelocation
func StopMessageLiveLocation(ctx context.Context, token string, params *StopMessageLiveLocationParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "stopMessageLiveLocation", params, result)
	return result, err
}

// SendVenue https://core.telegram.org/bots/api#sendvenue
func SendVenue(ctx context.Context, token string, params *SendVenueParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendVenue", params, result)
	return result, err
}

// SendContact https://core.telegram.org/bots/api#sendcontact
func SendContact(ctx context.Context, token string, params *SendContactParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendContact", params, result)
	return result, err
}

// SendPoll https://core.telegram.org/bots/api#sendpoll
func SendPoll(ctx context.Context, token string, params *SendPollParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendPoll", params, result)
	return result, err
}

// SendDice https://core.telegram.org/bots/api#senddice
func SendDice(ctx context.Context, token string, params *SendDiceParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendDice", params, &result)
	return result, err
}

// SendChatAction https://core.telegram.org/bots/api#sendchataction
func SendChatAction(ctx context.Context, token string, params *SendChatActionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "sendChatAction", params, &result)
	return result, err
}

// SetMessageReaction https://core.telegram.org/bots/api#setmessagereaction
func SetMessageReaction(ctx context.Context, token string, params *SetMessageReactionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMessageReaction", params, &result)
	return result, err
}

// GetUserProfilePhotos https://core.telegram.org/bots/api#getuserprofilephotos
func GetUserProfilePhotos(ctx context.Context, token string, params *GetUserProfilePhotosParams) (*models.UserProfilePhotos, error) {
	result := &models.UserProfilePhotos{}
	err := rawRequest(ctx, token, "getUserProfilePhotos", params, result)
	return result, err
}

// SetUserEmojiStatus https://core.telegram.org/bots/api#setuseremojistatus
func SetUserEmojiStatus(ctx context.Context, token string, params *SetUserEmojiStatusParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setUserEmojiStatus", params, &result)
	return result, err
}

// GetFile https://core.telegram.org/bots/api#getfile
func GetFile(ctx context.Context, token string, params *GetFileParams) (*models.File, error) {
	result := &models.File{}
	err := rawRequest(ctx, token, "getFile", params, result)
	return result, err
}

// BanChatMember https://core.telegram.org/bots/api#banchatmember
func BanChatMember(ctx context.Context, token string, params *BanChatMemberParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "banChatMember", params, &result)
	return result, err
}

// UnbanChatMember https://core.telegram.org/bots/api#unbanchatmember
func UnbanChatMember(ctx context.Context, token string, params *UnbanChatMemberParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unbanChatMember", params, &result)
	return result, err
}

// RestrictChatMember https://core.telegram.org/bots/api#restrictchatmember
func RestrictChatMember(ctx context.Context, token string, params *RestrictChatMemberParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "restrictChatMember", params, &result)
	return result, err
}

// PromoteChatMember https://core.telegram.org/bots/api#promotechatmember
func PromoteChatMember(ctx context.Context, token string, params *PromoteChatMemberParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "promoteChatMember", params, &result)
	return result, err
}

// SetChatAdministratorCustomTitle https://core.telegram.org/bots/api#setchatadministratorcustomtitle
func SetChatAdministratorCustomTitle(ctx context.Context, token string, params *SetChatAdministratorCustomTitleParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatAdministratorCustomTitle", params, &result)
	return result, err
}

// BanChatSenderChat https://core.telegram.org/bots/api#banchatsenderchat
func BanChatSenderChat(ctx context.Context, token string, params *BanChatSenderChatParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "banChatSenderChat", params, &result)
	return result, err
}

// UnbanChatSenderChat https://core.telegram.org/bots/api#unbanchatsenderchat
func UnbanChatSenderChat(ctx context.Context, token string, params *UnbanChatSenderChatParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unbanChatSenderChat", params, &result)
	return result, err
}

// SetChatPermissions https://core.telegram.org/bots/api#setchatpermissions
func SetChatPermissions(ctx context.Context, token string, params *SetChatPermissionsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatPermissions", params, &result)
	return result, err
}

// ExportChatInviteLink https://core.telegram.org/bots/api#exportchatinvitelink
func ExportChatInviteLink(ctx context.Context, token string, params *ExportChatInviteLinkParams) (string, error) {
	var result string
	err := rawRequest(ctx, token, "exportChatInviteLink", params, &result)
	return result, err
}

// CreateChatInviteLink https://core.telegram.org/bots/api#createchatinvitelink
func CreateChatInviteLink(ctx context.Context, token string, params *CreateChatInviteLinkParams) (*models.ChatInviteLink, error) {
	result := &models.ChatInviteLink{}
	err := rawRequest(ctx, token, "createChatInviteLink", params, &result)
	return result, err
}

// EditChatInviteLink https://core.telegram.org/bots/api#editchatinvitelink
func EditChatInviteLink(ctx context.Context, token string, params *EditChatInviteLinkParams) (*models.ChatInviteLink, error) {
	result := &models.ChatInviteLink{}
	err := rawRequest(ctx, token, "editChatInviteLink", params, &result)
	return result, err
}

// CreateChatSubscriptionInviteLink https://core.telegram.org/bots/api#createchatsubscriptioninvitelink
func CreateChatSubscriptionInviteLink(ctx context.Context, token string, params *CreateChatSubscriptionInviteLinkParams) (*models.ChatInviteLink, error) {
	result := &models.ChatInviteLink{}
	err := rawRequest(ctx, token, "createChatSubscriptionInviteLink", params, &result)
	return result, err
}

// EditChatSubscriptionInviteLink https://core.telegram.org/bots/api#editchatsubscriptioninvitelink
func EditChatSubscriptionInviteLink(ctx context.Context, token string, params *EditChatSubscriptionInviteLinkParams) (*models.ChatInviteLink, error) {
	result := &models.ChatInviteLink{}
	err := rawRequest(ctx, token, "editChatSubscriptionInviteLink", params, &result)
	return result, err
}

// RevokeChatInviteLink https://core.telegram.org/bots/api#revokechatinvitelink
func RevokeChatInviteLink(ctx context.Context, token string, params *RevokeChatInviteLinkParams) (*models.ChatInviteLink, error) {
	result := &models.ChatInviteLink{}
	err := rawRequest(ctx, token, "revokeChatInviteLink", params, &result)
	return result, err
}

// ApproveChatJoinRequest https://core.telegram.org/bots/api#approvechatjoinrequest
func ApproveChatJoinRequest(ctx context.Context, token string, params *ApproveChatJoinRequestParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "approveChatJoinRequest", params, &result)
	return result, err
}

// DeclineChatJoinRequest https://core.telegram.org/bots/api#declinechatjoinrequest
func DeclineChatJoinRequest(ctx context.Context, token string, params *DeclineChatJoinRequestParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "declineChatJoinRequest", params, &result)
	return result, err
}

// SetChatPhoto https://core.telegram.org/bots/api#setchatphoto
func SetChatPhoto(ctx context.Context, token string, params *SetChatPhotoParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatPhoto", params, &result)
	return result, err
}

// DeleteChatPhoto https://core.telegram.org/bots/api#deletechatphoto
func DeleteChatPhoto(ctx context.Context, token string, params *DeleteChatPhotoParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteChatPhoto", params, &result)
	return result, err
}

// SetChatTitle https://core.telegram.org/bots/api#setchattitle
func SetChatTitle(ctx context.Context, token string, params *SetChatTitleParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatTitle", params, &result)
	return result, err
}

// SetChatDescription https://core.telegram.org/bots/api#setchatdescription
func SetChatDescription(ctx context.Context, token string, params *SetChatDescriptionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatDescription", params, &result)
	return result, err
}

// PinChatMessage https://core.telegram.org/bots/api#pinchatmessage
func PinChatMessage(ctx context.Context, token string, params *PinChatMessageParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "pinChatMessage", params, &result)
	return result, err
}

// UnpinChatMessage https://core.telegram.org/bots/api#unpinchatmessage
func UnpinChatMessage(ctx context.Context, token string, params *UnpinChatMessageParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unpinChatMessage", params, &result)
	return result, err
}

// UnpinAllChatMessages https://core.telegram.org/bots/api#unpinallchatmessages
func UnpinAllChatMessages(ctx context.Context, token string, params *UnpinAllChatMessagesParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unpinAllChatMessages", params, &result)
	return result, err
}

// LeaveChat https://core.telegram.org/bots/api#leavechat
func LeaveChat(ctx context.Context, token string, params *LeaveChatParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "leaveChat", params, &result)
	return result, err
}

// GetChat https://core.telegram.org/bots/api#getchat
func GetChat(ctx context.Context, token string, params *GetChatParams) (*models.ChatFullInfo, error) {
	var result *models.ChatFullInfo
	err := rawRequest(ctx, token, "getChat", params, &result)
	return result, err
}

// GetChatAdministrators https://core.telegram.org/bots/api#getchatadministrators
func GetChatAdministrators(ctx context.Context, token string, params *GetChatAdministratorsParams) ([]models.ChatMember, error) {
	var result []models.ChatMember
	err := rawRequest(ctx, token, "getChatAdministrators", params, &result)
	return result, err
}

// GetChatMemberCount https://core.telegram.org/bots/api#getchatmembercount
func GetChatMemberCount(ctx context.Context, token string, params *GetChatMemberCountParams) (int, error) {
	var result int
	err := rawRequest(ctx, token, "getChatMemberCount", params, &result)
	return result, err
}

// GetChatMember https://core.telegram.org/bots/api#getchatmember
func GetChatMember(ctx context.Context, token string, params *GetChatMemberParams) (*models.ChatMember, error) {
	result := &models.ChatMember{}
	err := rawRequest(ctx, token, "getChatMember", params, &result)
	return result, err
}

// SetChatStickerSet https://core.telegram.org/bots/api#setchatstickerset
func SetChatStickerSet(ctx context.Context, token string, params *SetChatStickerSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatStickerSet", params, &result)
	return result, err
}

// GetForumTopicIconStickers https://core.telegram.org/bots/api#getforumtopiciconstickers
func GetForumTopicIconStickers(ctx context.Context, token string) ([]*models.Sticker, error) {
	var result []*models.Sticker
	err := rawRequest(ctx, token, "getForumTopicIconStickers", nil, &result)
	return result, err
}

// CreateForumTopic https://core.telegram.org/bots/api#createforumtopic
func CreateForumTopic(ctx context.Context, token string, params *CreateForumTopicParams) (*models.ForumTopic, error) {
	result := &models.ForumTopic{}
	err := rawRequest(ctx, token, "createForumTopic", params, &result)
	return result, err
}

// EditForumTopic https://core.telegram.org/bots/api#editforumtopic
func EditForumTopic(ctx context.Context, token string, params *EditForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "editForumTopic", params, &result)
	return result, err
}

// CloseForumTopic https://core.telegram.org/bots/api#closeforumtopic
func CloseForumTopic(ctx context.Context, token string, params *CloseForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "closeForumTopic", params, &result)
	return result, err
}

// ReopenForumTopic https://core.telegram.org/bots/api#reopenforumtopic
func ReopenForumTopic(ctx context.Context, token string, params *ReopenForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "reopenForumTopic", params, &result)
	return result, err
}

// UnpinAllForumTopicMessages https://core.telegram.org/bots/api#deleteforumtopic
func UnpinAllForumTopicMessages(ctx context.Context, token string, params *UnpinAllForumTopicMessagesParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unpinAllForumTopicMessages", params, &result)
	return result, err
}

// EditGeneralForumTopic https://core.telegram.org/bots/api#editgeneralforumtopic
func EditGeneralForumTopic(ctx context.Context, token string, params *EditGeneralForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "editGeneralForumTopic", params, &result)
	return result, err
}

// CloseGeneralForumTopic https://core.telegram.org/bots/api#closegeneralforumtopic
func CloseGeneralForumTopic(ctx context.Context, token string, params *CloseGeneralForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "closeGeneralForumTopic", params, &result)
	return result, err
}

// ReopenGeneralForumTopic https://core.telegram.org/bots/api#reopengeneralforumtopic
func ReopenGeneralForumTopic(ctx context.Context, token string, params *ReopenGeneralForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "reopenGeneralForumTopic", params, &result)
	return result, err
}

// HideGeneralForumTopic https://core.telegram.org/bots/api#hidegeneralforumtopic
func HideGeneralForumTopic(ctx context.Context, token string, params *HideGeneralForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "hideGeneralForumTopic", params, &result)
	return result, err
}

// UnhideGeneralForumTopic https://core.telegram.org/bots/api#unhidegeneralforumtopic
func UnhideGeneralForumTopic(ctx context.Context, token string, params *UnhideGeneralForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unhideGeneralForumTopic", params, &result)
	return result, err
}

// UnpinAllGeneralForumTopicMessages https://core.telegram.org/bots/api#unpinallgeneralforumtopicmessages
func UnpinAllGeneralForumTopicMessages(ctx context.Context, token string, params *UnpinAllGeneralForumTopicMessagesParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "unpinAllGeneralForumTopicMessages", params, &result)
	return result, err
}

// DeleteForumTopic https://core.telegram.org/bots/api#unpinallforumtopicmessages
func DeleteForumTopic(ctx context.Context, token string, params *DeleteForumTopicParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteForumTopic", params, &result)
	return result, err
}

// DeleteChatStickerSet https://core.telegram.org/bots/api#deletechatstickerset
func DeleteChatStickerSet(ctx context.Context, token string, params *DeleteChatStickerSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteChatStickerSet", params, &result)
	return result, err
}

// AnswerCallbackQuery https://core.telegram.org/bots/api#answercallbackquery
func AnswerCallbackQuery(ctx context.Context, token string, params *AnswerCallbackQueryParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "answerCallbackQuery", params, &result)
	return result, err
}

// GetUserChatBoosts https://core.telegram.org/bots/api#getuserchatboosts
func GetUserChatBoosts(ctx context.Context, token string, params *GetUserChatBoostsParams) (*models.UserChatBoosts, error) {
	result := &models.UserChatBoosts{}
	err := rawRequest(ctx, token, "getUserChatBoosts", params, &result)
	return result, err
}

// GetBusinessConnection https://core.telegram.org/bots/api#getbusinessconnection
func GetBusinessConnection(ctx context.Context, token string, params *GetBusinessConnectionParams) (*models.BusinessConnection, error) {
	result := &models.BusinessConnection{}
	err := rawRequest(ctx, token, "getBusinessConnection", params, &result)
	return result, err
}

// SetMyCommands https://core.telegram.org/bots/api#setmycommands
func SetMyCommands(ctx context.Context, token string, params *SetMyCommandsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMyCommands", params, &result)
	return result, err
}

// DeleteMyCommands https://core.telegram.org/bots/api#deletemycommands
func DeleteMyCommands(ctx context.Context, token string, params *DeleteMyCommandsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteMyCommands", params, &result)
	return result, err
}

// GetMyCommands https://core.telegram.org/bots/api#getmycommands
func GetMyCommands(ctx context.Context, token string, params *GetMyCommandsParams) ([]models.BotCommand, error) {
	var result []models.BotCommand
	err := rawRequest(ctx, token, "getMyCommands", params, &result)
	return result, err
}

// SetMyName https://core.telegram.org/bots/api#setmyname
func SetMyName(ctx context.Context, token string, params *SetMyNameParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMyName", params, &result)
	return result, err
}

// GetMyName https://core.telegram.org/bots/api#getmyname
func GetMyName(ctx context.Context, token string, params *GetMyNameParams) (models.BotName, error) {
	var result models.BotName
	err := rawRequest(ctx, token, "getMyName", params, &result)
	return result, err
}

// SetMyDescription https://core.telegram.org/bots/api#setmydescription
func SetMyDescription(ctx context.Context, token string, params *SetMyDescriptionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMyDescription", params, &result)
	return result, err
}

// GetMyDescription https://core.telegram.org/bots/api#getmydescription
func GetMyDescription(ctx context.Context, token string, params *GetMyDescriptionParams) (models.BotDescription, error) {
	var result models.BotDescription
	err := rawRequest(ctx, token, "getMyDescription", params, &result)
	return result, err
}

// SetMyShortDescription https://core.telegram.org/bots/api#setmyshortdescription
func SetMyShortDescription(ctx context.Context, token string, params *SetMyShortDescriptionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMyShortDescription", params, &result)
	return result, err
}

// GetMyShortDescription https://core.telegram.org/bots/api#getmyshortdescription
func GetMyShortDescription(ctx context.Context, token string, params *GetMyShortDescriptionParams) (models.BotShortDescription, error) {
	var result models.BotShortDescription
	err := rawRequest(ctx, token, "getMyShortDescription", params, &result)
	return result, err
}

// SetChatMenuButton https://core.telegram.org/bots/api#setchatmenubutton
func SetChatMenuButton(ctx context.Context, token string, params *SetChatMenuButtonParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setChatMenuButton", params, &result)
	return result, err
}

// GetChatMenuButton https://core.telegram.org/bots/api#getchatmenubutton
func GetChatMenuButton(ctx context.Context, token string, params *GetChatMenuButtonParams) (models.MenuButton, error) {
	var result models.MenuButton
	err := rawRequest(ctx, token, "getChatMenuButton", params, &result)
	return result, err
}

// SetMyDefaultAdministratorRights https://core.telegram.org/bots/api#setmydefaultadministratorrights
func SetMyDefaultAdministratorRights(ctx context.Context, token string, params *SetMyDefaultAdministratorRightsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setMyDefaultAdministratorRights", params, &result)
	return result, err
}

// GetMyDefaultAdministratorRights https://core.telegram.org/bots/api#getmydefaultadministratorrights
func GetMyDefaultAdministratorRights(ctx context.Context, token string, params *GetMyDefaultAdministratorRightsParams) (*models.ChatAdministratorRights, error) {
	result := &models.ChatAdministratorRights{}
	err := rawRequest(ctx, token, "setMyDefaultAdministratorRights", params, &result)
	return result, err
}
...
// EditMessageText https://core.telegram.org/bots/api#editmessagetext
func EditMessageText(ctx context.Context, token string, params *EditMessageTextParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "editMessageText", params, result)
	return result, err
}

// EditMessageCaption https://core.telegram.org/bots/api#editmessagecaption
func EditMessageCaption(ctx context.Context, token string, params *EditMessageCaptionParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "editMessageCaption", params, result)
	return result, err
}

// EditMessageMedia https://core.telegram.org/bots/api#editmessagemedia
func EditMessageMedia(ctx context.Context, token string, params *EditMessageMediaParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "editMessageMedia", params, result)
	return result, err
}

// EditMessageReplyMarkup https://core.telegram.org/bots/api#editmessagereplymarkup
func EditMessageReplyMarkup(ctx context.Context, token string, params *EditMessageReplyMarkupParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "editMessageReplyMarkup", params, result)
	return result, err
}

// StopPoll https://core.telegram.org/bots/api#stoppoll
func StopPoll(ctx context.Context, token string, params *StopPollParams) (*models.Poll, error) {
	result := &models.Poll{}
	err := rawRequest(ctx, token, "stopPoll", params, &result)
	return result, err
}

// DeleteMessage https://core.telegram.org/bots/api#deletemessage
func DeleteMessage(ctx context.Context, token string, params *DeleteMessageParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteMessage", params, &result)
	return result, err
}

// DeleteMessages https://core.telegram.org/bots/api#deletemessages
func DeleteMessages(ctx context.Context, token string, params *DeleteMessagesParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteMessages", params, &result)
	return result, err
}

// SendSticker https://core.telegram.org/bots/api#sendsticker
func SendSticker(ctx context.Context, token string, params *SendStickerParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendSticker", params, &result)
	return result, err
}

// GetStickerSet https://core.telegram.org/bots/api#getstickerset
func GetStickerSet(ctx context.Context, token string, params *GetStickerSetParams) (*models.StickerSet, error) {
	result := &models.StickerSet{}
	err := rawRequest(ctx, token, "getStickerSet", params, &result)
	return result, err
}

// GetCustomEmojiStickers https://core.telegram.org/bots/api#getcustomemojistickers
func GetCustomEmojiStickers(ctx context.Context, token string, params *GetCustomEmojiStickersParams) ([]*models.Sticker, error) {
	var result []*models.Sticker
	err := rawRequest(ctx, token, "getCustomEmojiStickers", params, &result)
	return result, err
}

// UploadStickerFile https://core.telegram.org/bots/api#uploadstickerfile
func UploadStickerFile(ctx context.Context, token string, params *UploadStickerFileParams) (*models.File, error) {
	result := &models.File{}
	err := rawRequest(ctx, token, "uploadStickerFile", params, &result)
	return result, err
}

// CreateNewStickerSet https://core.telegram.org/bots/api#createnewstickerset
func CreateNewStickerSet(ctx context.Context, token string, params *CreateNewStickerSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "createNewStickerSet", params, &result)
	return result, err
}

// AddStickerToSet https://core.telegram.org/bots/api#addstickertoset
func AddStickerToSet(ctx context.Context, token string, params *AddStickerToSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "addStickerToSet", params, &result)
	return result, err
}

// SetStickerPositionInSet https://core.telegram.org/bots/api#setstickerpositioninset
func SetStickerPositionInSet(ctx context.Context, token string, params *SetStickerPositionInSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerPositionInSet", params, &result)
	return result, err
}

// DeleteStickerFromSet https://core.telegram.org/bots/api#deletestickerfromset
func DeleteStickerFromSet(ctx context.Context, token string, params *DeleteStickerFromSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteStickerFromSet", params, &result)
	return result, err
}

// ReplaceStickerInSet https://core.telegram.org/bots/api#replacestickerinset
func ReplaceStickerInSet(ctx context.Context, token string, params *ReplaceStickerInSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "replaceStickerInSet", params, &result)
	return result, err
}

// SetStickerEmojiList https://core.telegram.org/bots/api#setstickeremojilist
func SetStickerEmojiList(ctx context.Context, token string, params *SetStickerEmojiListParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerEmojiList", params, &result)
	return result, err
}

// SetStickerKeywords https://core.telegram.org/bots/api#setstickerkeywords
func SetStickerKeywords(ctx context.Context, token string, params *SetStickerKeywordsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerKeywords", params, &result)
	return result, err
}

// SetStickerMaskPosition https://core.telegram.org/bots/api#setstickermaskposition
func SetStickerMaskPosition(ctx context.Context, token string, params *SetStickerMaskPositionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerMaskPosition", params, &result)
	return result, err
}

// SetStickerSetTitle https://core.telegram.org/bots/api#setstickermaskposition
func SetStickerSetTitle(ctx context.Context, token string, params *SetStickerSetTitleParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerSetTitle", params, &result)
	return result, err
}

// SetStickerSetThumbnail https://core.telegram.org/bots/api#setstickersetthumbnail
func SetStickerSetThumbnail(ctx context.Context, token string, params *SetStickerSetThumbnailParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setStickerSetThumbnail", params, &result)
	return result, err
}

// SetCustomEmojiStickerSetThumbnail https://core.telegram.org/bots/api#setcustomemojistickersetthumbnail
func SetCustomEmojiStickerSetThumbnail(ctx context.Context, token string, params *SetCustomEmojiStickerSetThumbnailParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setCustomEmojiStickerSetThumbnail", params, &result)
	return result, err
}

// DeleteStickerSet https://core.telegram.org/bots/api#deletestickerset
func DeleteStickerSet(ctx context.Context, token string, params *DeleteStickerSetParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "deleteStickerSet", params, &result)
	return result, err
}

// AnswerInlineQuery https://core.telegram.org/bots/api#answerinlinequery
func AnswerInlineQuery(ctx context.Context, token string, params *AnswerInlineQueryParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "answerInlineQuery", params, &result)
	return result, err
}

// AnswerWebAppQuery https://core.telegram.org/bots/api#answerwebappquery
func AnswerWebAppQuery(ctx context.Context, token string, params *AnswerWebAppQueryParams) (*models.SentWebAppMessage, error) {
	result := &models.SentWebAppMessage{}
	err := rawRequest(ctx, token, "answerWebAppQuery", params, result)
	return result, err
}

// SavePreparedInlineMessage https://core.telegram.org/bots/api#savepreparedinlinemessage
func SavePreparedInlineMessage(ctx context.Context, token string, params *SavePreparedInlineMessageParams) (*models.PreparedInlineMessage, error) {
	result := &models.PreparedInlineMessage{}
	err := rawRequest(ctx, token, "savePreparedInlineMessage", params, result)
	return result, err
}

// SendInvoice https://core.telegram.org/bots/api#sendinvoice
func SendInvoice(ctx context.Context, token string, params *SendInvoiceParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendInvoice", params, result)
	return result, err
}

// CreateInvoiceLink https://core.telegram.org/bots/api#createinvoicelink
func CreateInvoiceLink(ctx context.Context, token string, params *CreateInvoiceLinkParams) (string, error) {
	var result string
	err := rawRequest(ctx, token, "createInvoiceLink", params, &result)
	return result, err
}

// AnswerShippingQuery https://core.telegram.org/bots/api#answershippingquery
func AnswerShippingQuery(ctx context.Context, token string, params *AnswerShippingQueryParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "answerShippingQuery", params, &result)
	return result, err
}

// AnswerPreCheckoutQuery https://core.telegram.org/bots/api#answerprecheckoutquery
func AnswerPreCheckoutQuery(ctx context.Context, token string, params *AnswerPreCheckoutQueryParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "answerPreCheckoutQuery", params, &result)
	return result, err
}

// GetStarTransactions https://core.telegram.org/bots/api#getstartransactions
func GetStarTransactions(ctx context.Context, token string, params *GetStarTransactionsParams) (*models.StarTransactions, error) {
	result := models.StarTransactions{}
	err := rawRequest(ctx, token, "getStarTransactions", params, &result)
	return &result, err
}

// RefundStarPayment https://core.telegram.org/bots/api#refundstarpayment
func RefundStarPayment(ctx context.Context, token string, params *RefundStarPaymentParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "refundStarPayment", params, &result)
	return result, err
}

// EditUserStarSubscription https://core.telegram.org/bots/api#edituserstarsubscription
func EditUserStarSubscription(ctx context.Context, token string, params *EditUserStarSubscriptionParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "editUserStarSubscription", params, &result)
	return result, err
}

// SetPassportDataErrors https://core.telegram.org/bots/api#setpassportdataerrors
func SetPassportDataErrors(ctx context.Context, token string, params *SetPassportDataErrorsParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "setPassportDataErrors", params, &result)
	return result, err
}

// SendGame https://core.telegram.org/bots/api#sendgame
func SendGame(ctx context.Context, token string, params *SendGameParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "sendGame", params, result)
	return result, err
}

// SetGameScore https://core.telegram.org/bots/api#setgamescore
func SetGameScore(ctx context.Context, token string, params *SetGameScoreParams) (*models.Message, error) {
	result := &models.Message{}
	err := rawRequest(ctx, token, "setGameScore", params, result)
	return result, err
}

// GetGameHighScores https://core.telegram.org/bots/api#getgamehighscores
func GetGameHighScores(ctx context.Context, token string, params *GetGameHighScoresParams) ([]*models.GameHighScore, error) {
	var result []*models.GameHighScore
	err := rawRequest(ctx, token, "getGameHighScores", params, &result)
	return result, err
}

// GetAvailableGifts https://core.telegram.org/bots/api#getavailablegifts
func GetAvailableGifts(ctx context.Context, token string) (*models.Gifts, error) {
	result := &models.Gifts{}
	err := rawRequest(ctx, token, "getAvailableGifts", nil, result)
	return result, err
}

// SendGift https://core.telegram.org/bots/api#sendgift
func SendGift(ctx context.Context, token string, params *SendGiftParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "sendGift", params, &result)
	return result, err
}

// VerifyUser https://core.telegram.org/bots/api#verifyuser
func VerifyUser(ctx context.Context, token string, params *VerifyUserParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "verifyUser", params, &result)
	return result, err
}

// VerifyChat https://core.telegram.org/bots/api#verifychat
func VerifyChat(ctx context.Context, token string, params *VerifyChatParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "verifyChat", params, &result)
	return result, err
}

// RemoveUserVerification https://core.telegram.org/bots/api#removeuserverification
func RemoveUserVerification(ctx context.Context, token string, params *RemoveUserVerificationParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "removeUserVerification", params, &result)
	return result, err
}

// RemoveChatVerification https://core.telegram.org/bots/api#removechatverification
func RemoveChatVerification(ctx context.Context, token string, params *RemoveChatVerificationParams) (bool, error) {
	var result bool
	err := rawRequest(ctx, token, "removeChatVerification", params, &result)
	return result, err
}
